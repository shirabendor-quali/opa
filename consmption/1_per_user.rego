...
result = { "decision": "Denied", "reason": "This space has a limitation on the concurrent environments per user. You have reached this limit. Try terminating your currently active environments before launching a new one." }
if {
