...
result = {"decision": "Denied", "reason": concat("", ["This space has a limitation of ", data.max_active_envs_in_space_per_owner, "concurrent active environments per user. You have reached this limit. Try terminating one of your currently active environments before launching a new one."])} if {
